 ...
 * Description: Privacy policy page with Popeye Tours branding
 */
get_header();
?>

<!-- Page Header -->
<div class="page-header policy-page-header">
    <div class="policy-header-inner">
        <span class="ah-meta">Legal</span>
        <h1>Privacy Policy</h1>
        <p class="policy-header-sub">How we collect, use, and protect your personal information.</p>
    </div>
</div>
...
<div class="policy-body">
    ...
    <section class="policy-block">
        ...
        <h2 class="policy-subheading">Data collection on our website</h2>
        ...
        <h2 class="policy-subheading">Analytics and third-party tools</h2>
    ...
    <!-- Section 3: Data Collection Detail -->
    <section class="policy-block">
        ...
        <p>Cookies which are necessary to allow electronic communications or to provide certain functions you wish to use are stored pursuant to Art. 6 paragraph 1, letter f of the EU DSGVO/GDPR. The website operator has a legitimate interest in the storage of cookies to ensure an optimized service provided free of technical errors. If other cookies (such as those used to analyze your surfing behavior) are also stored, they will be treated separately in this privacy policy.</p>
        ...
        <p>The basis for data processing is Art. 6 (1) (f) of the EU DSGVO/GDPR, which allows the processing of data to fulfill a contract or for measures preliminary to a contract.</p>

        <h3>Contact form</h3>
        <p>Should you send us questions via contact form on our website, we will collect the data entered in the form, including the contact details you provide, to answer your question and any follow-up questions. We do not share this information without your permission.</p>
        <p>We will, therefore, process any data you enter in the contact form only with your consent per Art. 6 (1) (a) of the EU DSGVO/GDPR. You may revoke your consent at any time. An informal email making this request is sufficient. Data processed before we receive your request may still be legally processed.</p>
