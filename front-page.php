...
<section class="hero">
    ...
    <div class="hero-content">
        <h1>Popeye <span>Tours</span></h1>
        <p class="subtitle">Discover adventure and comfort with Popeye Tours your perfect gateway to unforgettable East African experiences, handpicked stays, and seamless journeys crafted entirely around you.</p>
        <div class="hero-ctas">
            ...
            <a href="mailto:immanuelmwabili@gmail.com" class="btn-secondary">Email us</a>
        </div>
